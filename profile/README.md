...
개발자, 디자이너, 기획자 등 다양한 전공의 학생들이 한 팀을 이루어 AI 전환(AX) 시대에 청년의 성장을 지원하는 디지털 혁신 문제를 해결하고, 혁신적인 아이디어를 실현합니다.

- 💡 **목표:** AI 전환(AX) 시대에 청년의 성장을 지원하는 디지털 혁신를 해결하는 창의적·혁신적 프로젝트 개발
...
1. **GitHub Organization 생성**
   - 팀 이름으로 Organization을 만들고 모든 Repository를 Public으로 설정하세요.
   - 예시: `X-THON-2025-Team0_Nexus`

2. **팀 리드미 작성**
   - 팀 소개, 아이디어 개요, 역할 분담, 개발 계획 등을 `README.md`에 정리합니다.
...
|:--:|:--|:--|:--|
| **Team 0 — Chord** | `2025-X-Thon-Team0-Chord` | [🔗 바로가기](링크) | 예) 소셜 연결 허브 서비스 |
| **Team 1 — 팀이름** | `2025-X-Thon-Team1-팀이름` | [🔗 바로가기](링크) |  |
| **Team 2 — 팀이름** | `2025-X-Thon-Team2-팀이름` | [🔗 바로가기](링크) |  |
| **Team 3 — 팀이름** | `2025-X-Thon-Team3-팀이름` | [🔗 바로가기](링크) |  |
| **Team 4 — 팀이름** | `2025-X-Thon-Team4-팀이름` | [🔗 바로가기](링크) |  |
| **Team 5 — 팀이름** | `2025-X-Thon-Team5-팀이름` | [🔗 바로가기](링크) |  |
| **Team 6 — 팀이름** | `2025-X-Thon-Team6-팀이름` | [🔗 바로가기](링크) |  |
| **Team 7 — 팀이름** | `2025-X-Thon-Team7-팀이름` | [🔗 바로가기](링크) |  |
| **Team 8 — 팀이름** | `2025-X-Thon-Team8-팀이름` | [🔗 바로가기](링크) |  |
| **Team 9 — 팀이름** | `2025-X-Thon-Team9-팀이름` | [🔗 바로가기](링크) |  |
| **Team 10 — 팀이름** | `2025-X-Thon-Team10-팀이름` | [🔗 바로가기](링크) |  |
| **Team 11 — 팀이름** | `2025-X-Thon-Team11-팀이름` | [🔗 바로가기](링크) |  |
| **Team 12 — 팀이름** | `2025-X-Thon-Team12-팀이름` | [🔗 바로가기](링크) |  |
| **Team 13 — 팀이름** | `2025-X-Thon-Team13-팀이름` | [🔗 바로가기](링크) |  |
...
> Let’s build the future — together at **X-THON 2025**.” 🚀

---

<p align="center">
  <sub>© 2025 X-THON Committee · Open Source Hackathon Initiative</sub>
</p>
